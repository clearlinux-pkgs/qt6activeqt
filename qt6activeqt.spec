...
Version  : 6.5.3
Release  : 1
URL      : https://download.qt.io/official_releases/qt/6.5/6.5.3/submodules/qtactiveqt-everywhere-src-6.5.3.tar.xz
Source0  : https://download.qt.io/official_releases/qt/6.5/6.5.3/submodules/qtactiveqt-everywhere-src-6.5.3.tar.xz
...
%prep
%setup -q -n qtactiveqt-everywhere-src-6.5.3
cd %{_builddir}/qtactiveqt-everywhere-src-6.5.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1696286772
mkdir -p clr-build
pushd clr-build
