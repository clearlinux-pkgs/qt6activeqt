...
Version  : 6.6.0
Release  : 2
URL      : https://download.qt.io/official_releases/qt/6.6/6.6.0/submodules/qtactiveqt-everywhere-src-6.6.0.tar.xz
Source0  : https://download.qt.io/official_releases/qt/6.6/6.6.0/submodules/qtactiveqt-everywhere-src-6.6.0.tar.xz
...
%prep
%setup -q -n qtactiveqt-everywhere-src-6.6.0
cd %{_builddir}/qtactiveqt-everywhere-src-6.6.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697145795
mkdir -p clr-build
pushd clr-build
