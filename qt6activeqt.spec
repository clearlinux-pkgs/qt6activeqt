...
Version  : 6.9.0
Release  : 24
URL      : https://download.qt.io/official_releases/qt/6.9/6.9.0/submodules/qtactiveqt-everywhere-src-6.9.0.tar.xz
Source0  : https://download.qt.io/official_releases/qt/6.9/6.9.0/submodules/qtactiveqt-everywhere-src-6.9.0.tar.xz
...
%prep
%setup -q -n qtactiveqt-everywhere-src-6.9.0
cd %{_builddir}/qtactiveqt-everywhere-src-6.9.0
pushd ..
cp -a qtactiveqt-everywhere-src-6.9.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743640528
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/qt6/sbom/qtactiveqt-6.9.0.spdx
